...
protected:
    ...
    touchgfx::TextAreaWithOneWildcard totalDistance_1;
    touchgfx::TextArea totalDistanceMi_1;
    ...
    touchgfx::ScalableImage high_beam;
    touchgfx::ScalableImage aux_L;
    touchgfx::ScalableImage indi_left;
    touchgfx::ScalableImage indi_right;
    touchgfx::ScalableImage fault;
    touchgfx::ScalableImage side_stand;
    touchgfx::ScalableImage tork_logo;

    /*
     * Wildcard Buffers
     */
    static const uint16_t TOTALDISTANCE_1_SIZE = 11;
    touchgfx::Unicode::UnicodeChar totalDistance_1Buffer[TOTALDISTANCE_1_SIZE];
    static const uint16_t CURRENTVELOCITY_SIZE = 6;
